...
<body>
	...
	<div class="modal-container" id="myModal">
	 ...
	 <!-- DELETE SAVED JOB -->
	 <div class="delete-modal-container" id="delete-modalContainer">
...
<div id="apply-myModal" class="apply-modal">
	...
	<section id="content">
		...
		<nav>
			...
			<form action="candidate-saved-jobs-index.php" method="post">
...
?>
		...
		if(isset($_POST['search-btn']))
		{
			...
			$query = "SELECT * FROM saved_jobs WHERE CONCAT(company_name, company_address, job_position, job_description, job_qualification, job_salary, job_type, keyword1, keyword2, keyword3) LIKE '%$filtervalues%' AND applicant_id = '$app_id' ORDER BY id DESC";
			$search_result = filterTable($query);
		}
		 else {
			
			$query = "SELECT * FROM saved_jobs WHERE applicant_id = '$app_id' ORDER BY id DESC";
			$search_result = filterTable($query);
		}
...
<script type='text/javascript'>
             $(document).ready(function(){
                $('.card-container').click(function(){
                    ...
                    $.ajax({
                        url: 'candidate-saved-jobpost-ajax.php',
                        type: 'post',
                        data: {userid: userid},
