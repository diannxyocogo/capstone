...
session_start();
    ...
    $sql = "UPDATE applicants SET applicant_status = 'Interview' WHERE id = '$id'";
...
$subject = 'Application';
$body = 'You are now accepted on the Screening phase, please wait for the interview schedule. 
<br><br>

<b>Company: ' .$row["company_name"]. '</b> <br>
<b>Position: ' .$row["job_position"]. '</b> <br>
