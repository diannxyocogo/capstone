...
$sql = "SELECT company_logo, company_name, job_position  FROM saved_jobs WHERE id = '$userid'";
$result = mysqli_query($conn,$sql);
while( $row = mysqli_fetch_array($result) ){
?>
 <h2>Apply Job</h2>
    <form action="apply-saved-job-query.php" method="post" autocomplete="off" enctype="multipart/form-data">
      <div class="grid-container">
        ...
        <div class="grid-item">
          ...
          <input type="text" id="job_position" name="job_position" value="<?php echo $row['job_position']?>" readonly>
        </div>
        </div>
        <?php } ?>
...
?>
        ...
        <form action="./candidate-saved-jobs-index.php">
