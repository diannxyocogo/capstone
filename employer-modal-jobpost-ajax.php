...
?>
<a href ="employer-job-posting-index.php"><span class="close">&times;</span></a>
 <img class="company-logo" src="image/<?php echo $row['company_logo']; ?>" alt="<?php echo $row['company_name']; ?>">
