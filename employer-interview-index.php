  ...
  <div class="edit-modal-content">
	...
	<section id="content">
		...
		<nav>
			...
			<form action="employer-interview-index.php" method="post">
...
?>
		...
		if(isset($_POST['search-btn']))
		{
			...
			$query = "SELECT * FROM applicants WHERE CONCAT(job_position, applicant_name) LIKE '%$filtervalues%' AND company_name = '$que[business_name]' AND applicant_status = 'Interview' ORDER BY id DESC";
			$search_result = filterTable($query);
				...
				$query = "SELECT * FROM applicants WHERE company_name = '$que1[business_name]' AND applicant_status = 'Interview' ORDER BY id DESC";
				$search_result = filterTable($query);
...
<?php while($row = mysqli_fetch_array($search_result)):?>
                    <tr>
						...
						<td>
							<?php if($row['interview_date'] == 'Not Set'){ ?>
							...
							<?php } else { ?>
								<?php echo $row['interview_date']. ' / ' .$row['interview_time']; ?>
							<?php } ?>

							</td>
                        <td><?php echo $row['date_applied']; ?></td>
						<td>
							<button class="suitable"><a href="pass.php?app_id=<?php echo $row['id']?>">Pass</a></button>
							</td>
							<td>
							<button class="nsuitable"><a href="fail.php?app_id=<?php echo $row['id']?>">Fail</a></button>
					</td>
                    </tr>
					<?php endwhile;?>
                </table>
